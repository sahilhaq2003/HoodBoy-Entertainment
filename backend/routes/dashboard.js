...
const { getDashboardStats, getMonthlyFinancials, getProjectStatusBreakdown, getUpcomingDeadlines, getUnifiedDashboard, getRoleDashboard, getMyProfile, updateMyProfile, uploadMyImage, removeMyImage } = require('../controllers/dashboardController');
...
router.delete('/profile/image', checkPermission('dashboard', 'write'), removeMyImage);
